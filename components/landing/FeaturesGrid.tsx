const FEATURES = [
  {
    ...
    description:
      "Don’t just see the data—get clear next steps. Postmetric analyzes your analytics and nudges you with actions to convert more visitors.",
  },
  {
    icon: (
      <svg
    ...
    description:
      "Turn alerts into actions. Build workflows that run when something changes—so you perform the right action, not just get the notification.",
  },
  {
    icon: (
      <svg
    ...
    description:
      "Stop drowning in dashboards. For every insight we show you the single action that will move the needle most—so you can change the game, not just watch it.",
  },
  {
    icon: (
      <svg
