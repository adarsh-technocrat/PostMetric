...
export function Footer() {
  return (
    <footer className="flex w-full flex-col gap-10 px-4 md:px-6 pb-10 pt-10">
      <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
        <div className="col-span-2 md:col-span-2 flex flex-col gap-4 pr-8">
          ...
          <p className="text-stone-500 text-sm leading-6 max-w-xs">
            Simple analytics for developers and makers. Privacy-friendly and
            cookie-free.
          </p>
        ...
        <div className="flex flex-col gap-4">
          <p className="text-stone-800 font-medium text-xs uppercase font-mono leading-4">
            Product
          </p>
